...
/*global tinymce:true */
var url_upload_media = upload_tool_url;

window.addEventListener('message', function(event) {
    if(event.data.meta.callback == 'getFileFullUrl') {
        getFileFullUrl(event.data);
    }
}, false);

function getFileFullUrl(option)
{
	console.log(option);
    $('#' + option.meta.inputreceive).val(option.data[0].link)
    //.after('<div><img src="'+ option.data[0].link +'" alt="" /></div>');
    $.fancybox.close();
}
	...
	function showDialog(imageList) {
        ...
        generalFormItems.push({
            ...
            onclick: function(event){
                ...
                var url = url_upload_media + '?callback=getFileFullUrl&input-receive=chooseImage-inp';
                $.fancybox({
                    'width': '90%',
                    'height': '90%',
                    'autoScale': true,
